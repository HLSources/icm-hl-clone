...
int CHudAmmo::MsgFunc_CurWeapon(const char *pszName, int iSize, void *pbuf )
{
	...
	//arsh0r - crosshairs
	if (!strcmp(m_pWeapon->szName, "weapon_9mmAR"))
		gHUD.icm_crosshair = CROSS_MAC10;
	if (!strcmp(m_pWeapon->szName, "weapon_rpg"))
		gHUD.icm_crosshair = CROSS_ROCKET;
	if (!strcmp(m_pWeapon->szName, "weapon_crossbow"))
		gHUD.icm_crosshair = CROSS_DOT;
	if (!strcmp(m_pWeapon->szName, "weapon_crowbar"))
		gHUD.icm_crosshair = CROSS_NOCROSS;
	if (!strcmp(m_pWeapon->szName, "weapon_handgrenade"))
		gHUD.icm_crosshair = CROSS_NOCROSS;
	if (!strcmp(m_pWeapon->szName, "weapon_duebel"))
		gHUD.icm_crosshair = CROSS_NOCROSS;
