...
int CHudDeathNotice :: MsgFunc_DeathMsg( const char *pszName, int iSize, void *pbuf )
{
	...
	else
	{
		...
		if ( killedwith && *killedwith && (*killedwith > 13 ) && strcmp( killedwith, "d_world" ) && !rgDeathNoticeList[i].iTeamKill )
		{
			...
			if ( !strcmp( killedwith+2, "crowbar" ) )
				strcpy( killedwith, "d_lightsaber" );
			if ( !strcmp( killedwith+2, "9mmAR" ) )
				strcpy( killedwith, "d_ingram mac10" );
			if ( !strcmp( killedwith+2, "rpg_rocket" ) )
				strcpy( killedwith, "d_rocketmac" );
			if ( !strcmp( killedwith+2, "crossbow" ) )
				strcpy( killedwith, "d_sniper mac" );
