	...
	if (gHUD.m_iWeaponBits & (1<<(WEAPON_SUIT)))
	{
		...
		switch (gHUD.icm_crosshair)
		{
			...
			case CROSS_MAC10:
				...
				iWidth = 1;
				x = (ScreenWidth/2);
				y = (ScreenHeight/2) - (ScreenWidth/RelativeX) - (ScreenWidth/SpaceX);
				FillRGBA(x, y, iWidth, iHeight, 255, 0, 0, 128); //oben
				y = (ScreenHeight/2) + (ScreenWidth/SpaceX);
				FillRGBA(x, y, iWidth, iHeight, 255, 0, 0, 128); //unten
				
				iHeight = 1;
				iWidth = (ScreenHeight/RelativeY);
				y = (ScreenHeight/2);
				x = (ScreenWidth/2) + (ScreenHeight/SpaceY);
				FillRGBA(x, y, iWidth, iHeight, 255, 0, 0, 128); //rechts
				x = (ScreenWidth/2) - (ScreenHeight/RelativeY) - (ScreenHeight/SpaceY);
				FillRGBA(x, y, iWidth, iHeight, 255, 0, 0, 128); //links
				break;
