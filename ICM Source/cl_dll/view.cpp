...
int V_FindViewModelByWeaponModel(int weaponindex)
{
	...
	static char * modelmap[][2] =	{
		{ "models/p_duebel.mdl",		"models/v_duebel.mdl"		},
		{ "models/p_grumbern.mdl",		"models/v_grumbern.mdl"		},
		{ "models/p_mac10.mdl",			"models/v_mac10.mdl"			},
		{ "models/p_mac10r.mdl",		"models/v_mac10r.mdl"		},
		{ "models/p_mac10s.mdl",		"models/v_mac10s.mdl"	},
