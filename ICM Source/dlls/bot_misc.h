...
//	int		NumBotsDefault;
	...
	void	IncreaseDifficulty( void ) { if ( bot_skill.value < 99 ) (bot_skill.value)++; else (bot_skill.value) = 100; }
	void	DecreaseDifficulty( void ) { if ( bot_skill.value > 1 ) (bot_skill.value)--; else (bot_skill.value) = 0; }
