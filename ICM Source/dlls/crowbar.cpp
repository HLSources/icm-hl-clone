...
void CCrowbar::Spawn( )
{
	...
	SET_MODEL(ENT(pev), "models/w_sabre.mdl");
	m_iClip = -1;
...
{
	PRECACHE_MODEL("models/v_sabre.mdl");
	PRECACHE_MODEL("models/w_sabre.mdl");
	PRECACHE_MODEL("models/p_sabre.mdl");
...
{
	return DefaultDeploy( "models/v_sabre.mdl", "models/p_sabre.mdl", CROWBAR_DRAW, "crowbar" );
}
