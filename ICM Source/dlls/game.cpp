...
// 0 prevents players from being spectators
// multiplayer server rules
...
cvar_t	teamlist = {"mp_teamlist","schnittlauchs;saubazis", FCVAR_SERVER };
...
//END BOT
	...
	SERVER_COMMAND( "exec icmbot.cfg\n" );
}
