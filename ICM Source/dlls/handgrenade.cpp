...
void CHandGrenade::Spawn( )
{
	...
	SET_MODEL(ENT(pev), "models/w_grumbern.mdl");
...
{
	PRECACHE_MODEL("models/w_grumbern.mdl");
	PRECACHE_MODEL("models/v_grumbern.mdl");
	PRECACHE_MODEL("models/p_grumbern.mdl");
}
...
{
	m_flReleaseThrow = -1;
	return DefaultDeploy( "models/v_grumbern.mdl", "models/p_grumbern.mdl", HANDGRENADE_DRAW, "crowbar" );
}
