...
{
	UTIL_SayTextAll( "ingram chillin' mod v1.0-rc4 \"ten years of chillin'\"-edition\n", pl );
...
void CHalfLifeMultiplay :: PlayerSpawn( CBasePlayer *pPlayer )
{
	...
	if ( addDefault )
	{
		...
		pPlayer->GiveNamedItem( "weapon_duebel" );
...
void CHalfLifeMultiplay::DeathNotice( CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pevInflictor )
{
	...
	if ( pKiller->flags & FL_CLIENT )
	{
		...
		if ( pevInflictor )
		{
			if ( pevInflictor == pKiller )
			{
				...
				if ( pPlayer->DidKamikaze() == 1 )
				{
					killer_weapon_name = "kamikaze";
				}
			}
			else
			{
	...
	if ( !strcmp( killer_weapon_name, "crowbar" ) )
		killer_weapon_name = "lightsaber";
	else if ( !strcmp( killer_weapon_name, "9mmAR" ) )
		killer_weapon_name = "ingram mac10";
	else if ( !strcmp( killer_weapon_name, "rpg_rocket" ) )
		killer_weapon_name = "rocketmac";
	else if ( !strcmp( killer_weapon_name, "crossbow" ) )
		killer_weapon_name = "sniper mac";
