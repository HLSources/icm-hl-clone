...
// the graph has two flags, and should not be accessed unless both flags are TRUE!
	...
	void		slurp_array(NAV_ARRAY_TYPE space_array[NAV_ARRAY_SIZE][NAV_ARRAY_SIZE][NAV_ARRAY_SIZE], char* filename);
...
#define NUM_RANGES 256
	...
	int		FLoadBotNav(char *szMapName);
