...
void CCrossbow::Spawn( )
{
	...
	SET_MODEL(ENT(pev), "models/w_mac10s.mdl");
...
{
	PRECACHE_MODEL("models/w_mac10s.mdl");
	PRECACHE_MODEL("models/v_mac10s.mdl");
	PRECACHE_MODEL("models/p_mac10s.mdl");
...
{
	return DefaultDeploy( "models/v_mac10s.mdl", "models/p_mac10s.mdl", CROSSBOW_DRAW1, "onehanded" );
}
...
void CCrossbow::Reload( void )
{
	...
	DefaultReload( 5, CROSSBOW_RELOAD, 3 );
}
